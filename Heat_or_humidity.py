...
#The columns of interest are 'dew_point_faren' and 'dry_bulb_faren'. After resampling them 
#appropriately to get the maximum temperature and dew point in each month, generate a histogram 
#of these values as subplots. Uncomfortably, you will notice that the maximum dew point is above 65 every month!
